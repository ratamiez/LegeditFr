...
public class CardMakerToolbar extends JMenuBar implements ActionListener{
	...
	JMenuItem newExpansion = new JMenuItem(Messages.getString("Toolbar.New"));
	JMenuItem open = new JMenuItem(Messages.getString("Toolbar.Open"));
	JMenuItem save = new JMenuItem(Messages.getString("Toolbar.Save"));
	JMenuItem saveAs = new JMenuItem(Messages.getString("Toolbar.SaveAs"));
	JMenuItem exit = new JMenuItem(Messages.getString("Toolbar.Exit"));
	...
	JMenuItem exportSelectedJPEGHomeprint = new JMenuItem(Messages.getString("Toolbar.ExportSelectedItemsJPEGHomePrint"));
	JMenuItem exportDividersJPEGHomeprint = new JMenuItem(Messages.getString("Toolbar.ExportDividersJPEGHomePrint"));
	JMenuItem exportFull = new JMenuItem(Messages.getString("Toolbar.ExportFullExpansion"));
	
	JMenuItem viewAsText = new JMenuItem(Messages.getString("Toolbar.ViewAsText"));
	JMenuItem viewStatistics = new JMenuItem(Messages.getString("Toolbar.ViewStatistics"));
	...
	JMenu editMenu = new JMenu(Messages.getString("Toolbar.Edit"));
	
	
	JMenu divider = new JMenu(Messages.getString("Toolbar.Templates"));
	
	JMenu orientation = new JMenu(Messages.getString("Toolbar.DividerOrientation"));
	JCheckBoxMenuItem orientationHorizontal = new JCheckBoxMenuItem(Messages.getString("Toolbar.Horizontal"));
	JCheckBoxMenuItem orientationVertical = new JCheckBoxMenuItem(Messages.getString("Toolbar.Vertical"));
	JMenuItem editHeroDividerTemplate = new JMenuItem(Messages.getString("Toolbar.EditHeroDividerTemplate"));
	JMenuItem editVillainDividerTemplate = new JMenuItem(Messages.getString("Toolbar.EditVillainDividerTemplate"));
	JMenuItem editHeroTemplate = new JMenuItem(Messages.getString("Toolbar.EditHeroTemplate"));
	
	JMenu expansion = new JMenu(Messages.getString("Toolbar.Expansion"));
	JMenu style = new JMenu(Messages.getString("Toolbar.Style"));
	List<JCheckBoxMenuItem> styleItems = new ArrayList<JCheckBoxMenuItem>();
	JMenuItem expansionName = new JMenuItem(Messages.getString("Toolbar.ExpansionName"));
	JMenuItem rules = new JMenuItem(Messages.getString("Toolbar.EditRules"));
	JMenuItem keywords = new JMenuItem(Messages.getString("Toolbar.EditKeywords"));
	
	JMenu tools = new JMenu(Messages.getString("Toolbar.Tools"));
	JMenuItem campaignManager = new JMenuItem(Messages.getString("Toolbar.CampaignManager"));
	JMenuItem bleeder = new JMenuItem(Messages.getString("Toolbar.Bleeder"));
	
	JMenu help = new JMenu(Messages.getString("Toolbar.Help"));
	...
	public CardMakerToolbar(LegendaryCardMakerFrame lcmf)
	{
		...
		JMenuItem version = new JMenuItem(Messages.getString("Toolbar.Version")+": " + LegendaryCardMaker.version);
	...
	public void actionPerformed(ActionEvent e) {
		...
		{
			String s = JOptionPane.showInputDialog(lcmf, Messages.getString("IHM.EnterExpansionName"), lcmf.lcm.expansionName);
	...
	public void setEditMenu()
	{
		...
		if (str.equals(Messages.getString("Card.Heroes")))
		{
			remove(1);
			add(heroSelectorMenu, 1);
			return;
		}
		if (str.equals(Messages.getString("Card.Villains")))
		{
			remove(1);
			add(villainSelectorMenu, 1);
			return;
		}
		if (str.equals(Messages.getString("Card.Schemes")))
		{
			remove(1);
			add(schemeSelectorMenu, 1);
			return;
		}
		if (str.equals(Messages.getString("Card.Teams")))
		{
			remove(1);
			add(teamSelectorMenu, 1);
			return;
		}
		if (str.equals(Messages.getString("Card.Bystanders")))
		{
			remove(1);
			add(bystanderSelectorMenu, 1);
			return;
		}
		if (str.equals(Messages.getString("Card.Wounds")))
		{
			remove(1);
			add(woundSelectorMenu, 1);
			return;
		}
		if (str.equals(Messages.getString("Card.Bindings")))
		{
			remove(1);
			add(bindingsSelectorMenu, 1);
			return;
		}
		if (str.equals(Messages.getString("Card.SchemeTypes")))
		{
			remove(1);
