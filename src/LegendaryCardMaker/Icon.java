...
public final class Icon implements Comparator<Icon>, Comparable<Icon> {
	...
	*/
	...
	{
		System.out.println(Messages.getString("Logs.LoadingIcons")+"...");
		
		icons = new ArrayList<Icon>();
		
		System.out.println(Messages.getString("Logs.LoadingTeams")+"...");
		...
		{	
				...
				while ((line = br.readLine()) != null) {
				   if (line != null && !line.startsWith("#") && !line.isEmpty())
				   {
					   try
					   {
						   ...
						   icons.add(i);
						   System.out.println(Messages.getString("Logs.Loaded")+": " + i.getEnumName()); 
					   }
					   catch (Exception e)
					   {
						   System.err.println(Messages.getString("Logs.FailedToLoad")+": " + line);
					   }					   
				   }
				}
			}
			...
			{
				System.err.println(Messages.getString("Logs.ErrorLoadingTeamsIcons"));
				e.printStackTrace();
			}
		}
		
		System.out.println(Messages.getString("Logs.LoadingPowers")+"...");
		...
		System.out.println(Messages.getString("Logs.LoadingAttributes")+"...");
		...
		System.out.println(Messages.getString("Logs.IconsLoaded")+"...");
	}
