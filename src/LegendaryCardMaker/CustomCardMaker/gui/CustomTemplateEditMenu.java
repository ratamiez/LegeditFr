...
public class CustomTemplateEditMenu extends JMenu implements ActionListener {
	...
	private JMenu newMenu = new JMenu(Messages.getString("Toolbar.New"));
	...
	{
		super(Messages.getString("Toolbar.Edit"));
		...
		{
			JMenuItem newItem = new JMenuItem(Messages.getString("Toolbar.New")+" " + list.templateList.get(0).templateDisplayName);
			newItem.addActionListener(this);
		...
		{
			JMenuItem newItem = new JMenuItem(Messages.getString("Toolbar.New")+" " + list.structures.get(0).displayName);
			newItem.addActionListener(this);
		...
		JMenuItem editItem = new JMenuItem(Messages.getString("Toolbar.EditCard"));
		editItem.addActionListener(this);
		editItem.setActionCommand("edit_card");
		add(editItem);
		
		JMenuItem deleteItem = new JMenuItem(Messages.getString("Toolbar.DeleteCard"));
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getActionCommand().startsWith("delete_card"))
		{
        	...
        	if (cc != null)
        	{
        		int outcome = JOptionPane.showOptionDialog(LegendaryCardMakerFrame.lcmf, Messages.getString("IHM.DeleteCard"), Messages.getString("IHM.DeleteHeros"), JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE, null, null, null);
