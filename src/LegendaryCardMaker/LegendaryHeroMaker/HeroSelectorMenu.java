...
public class HeroSelectorMenu extends JMenu implements ActionListener{
	...
	JMenuItem newHero = new JMenuItem(Messages.getString("Toolbar.NewHero"));
	JMenuItem edit = new JMenuItem(Messages.getString("Toolbar.EditHero"));
	JMenuItem rename = new JMenuItem(Messages.getString("Toolbar.RenameHero"));
	JMenuItem delete = new JMenuItem(Messages.getString("Toolbar.DeleteHero"));
	...
	JMenu team = new JMenu(Messages.getString("Toolbar.SetTeam"));
