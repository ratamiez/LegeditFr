...
public final class SchemeCardType implements Comparator<SchemeCardType>, Comparable<SchemeCardType> {
	...
	*/
	...
	{
		System.out.println(Messages.getString("Logs.LoadingSchemeCardTypes")+"...");
		...
		{	
			...
			{
				System.err.println(Messages.getString("Logs.ErrorLoadingSchemeTypes"));
				e.printStackTrace();
			}
		}
		
		System.out.println(Messages.getString("Logs.SchemeCardTypesLoaded")+"...");
	}
